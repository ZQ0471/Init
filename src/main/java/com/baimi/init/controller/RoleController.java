...
public class RoleController {
     ...
     **/
    @MLog(remark = "获取角色列表",operationType = OperationType.LIST)
     ...
     * @return Result
     **/
    @MLog(remark = "新增角色",operationType = OperationType.INSERT)
    ...
    @MLog(remark = "修改角色",operationType = OperationType.UPDATE)
    @PostMapping("/update")
